                  ...
                  <TableRow key={event.id} className="bg-black hover:bg-green-900">
                    ...
                    <TableCell className="border border-green-500 px-2 py-1">
                      <Link
                        ...
                        className="inline-flex items-center justify-center whitespace-nowrap text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-9 bg-blue-600 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-none border-2 border-white mr-2"
                      >
                        Edit
                      </Link>
                      <Button
