    ...
    return (
        <div className="min-h-screen bg-black text-green-400 p-4 font-mono">
            ...
            <div className="container mx-auto max-w-md">
                <h1 className="text-4xl font-bold mb-8 text-center animate-pulse">Registration</h1>
                <div className="border-4 border-green-400 p-8 rounded-lg shadow-lg shadow-green-400/50">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-none border-2 border-white">
                                Register Player
                            </Button>
                        </form>
                    </Form>
