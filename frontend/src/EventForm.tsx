...
export default function EventForm() {
    ...
    useEffect(() => {
        if (id) {
            fetchEventTypes().then(r => fetchEvent(parseInt(id)).then());
        }
    }, [id])
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="flex justify-between">
                                <Button
                                    ...
                                    className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-none border-2 border-white"
                                >
                                    Cancel
                                </Button>
                                <Button
                                    type="submit"
                                    className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-none border-2 border-white"
                                >
